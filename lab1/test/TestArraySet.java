...
public class TestArraySet {
	...
	public final void addAll()	{
		s.add(2);
		ArraySet<Integer> temp = new ArraySet<Integer>();
		assertFalse("Error with empty ArraySet",s.addAll(temp));
		temp.add(1);
		assertTrue("Incorrect method",s.addAll(temp));
		s.add(1);
		temp.add(2);
		assertFalse("Already contained characters", s.addAll(temp));
